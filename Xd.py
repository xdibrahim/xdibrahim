...
# coding=utf-8
# Coded Byxdibrahim
# My Facebook ( https://www.facebook.com/xdibrahim-102896575436747/ )
...
\033[1;97m
  _______  _______  __
___  _ ____  _  ____  ____  ____  _     _  _     
\  \///  _ \/ \/  _ \/  __\/  _ \/ \ /|/ \/ \__/|
 \  / | | \|| || | //|  \/|| / \|| |_||| || |\/||
 /  \ | |_/|| || |_\\|    /| |-||| | ||| || |  ||
...
\033[1;95m|| Created Byxdibrahim
\033[1;94m|| Github.com/Red-Mafia
\033[0;91mv2.0  \033[0m|| Facebook.ibrahim'''
...
def info_tools():
    ...
    print '\n %s[%s>%s] Yt       :xdibrahim'%(N,H,N);time.sleep(0.07)
    print '\n %s[%s>%s] Author   :xdibrahim(RK).'%(N,H,N);time.sleep(0.07)
    print '\n %s[%s>%s] Github   : https://github.com/Red-Mafia'%(N,H,N);time.sleep(0.07)
    print '\n %s[%s>%s] Facebook : https://www.facebook.com/xdibrahim-102896575436747/'%(N,H,N);time.sleep(0.07)
    print '\n %s[%s>%s] Fanspage : https://www.facebook.com/xdibrahim-102896575436747/'%(N,H,N);time.sleep(0.07)
